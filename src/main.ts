...
const createWindow = () => {
    ...
    monitor.eventEmitter.on('monitor-stopped', () =>
        mainWindow.webContents.send('monitor-stopped', {})
    );
    monitor.eventEmitter.on('monitor-error', (error: string) =>
        mainWindow.webContents.send('monitor-error', error)
    );
    monitor.eventEmitter.on('heartbeat-sent', () =>
        mainWindow.webContents.send('heartbeat-sent', {})
    );
    monitor.eventEmitter.on('heartrate-update', (newHeartRate: number) =>
        mainWindow.webContents.send('heartrate-update', newHeartRate)
    );
    ...
    ipcMain.on(
        'start-hyperate-monitor',
        (_, params: StartHyperateMonitorParams) => {
